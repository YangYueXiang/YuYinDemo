...
import com.xyd.yuyindemo.util.FucUtil;
import com.xyd.yuyindemo.util.JsonParser;
import com.xyd.yuyindemo.util.XmlParser;
...
//				mAsr.setParameter(SpeechConstant.SAMPLE_RATE, "8000");
	...
	public boolean setParam(){
		...
		else
		{
			...
			// 设置识别的门限值
			mAsr.setParameter(SpeechConstant.MIXED_THRESHOLD, "2500");
			// 使用8k音频的时候请解开注释
//			mAsr.setParameter(SpeechConstant.SAMPLE_RATE, "8000");
			result = true;
		}
